...
###             SPHERE WITH PML LAYER Geometry + Mesh               ###
...
#import os 
#path = os.environ['PWD'] #+ 'mesh' ## MODIFY PATH to mesh location
#del os
...
Fluid = geompy.MakeCutList(B, [Sphere], True)
...
geompy.addToStudy( Fluid, 'Fluid Domain' )
...
NETGEN_3D_Simple_Parameters_1.SetNumberOfSegments(NETGEN_mesh_param)
...
try:
    DomainMesh.ExportUNV(path + '/unv/sphere_' + str(NETGEN_mesh_param) +'.unv' )
    pass
except:
    print 'ExportUNV() failed. Invalid path specified :', path + '/unv/sphere_' + str(NETGEN_mesh_param) +'.unv'


## Set names of Mesh objects
smesh.SetName(NETGEN_1D_2D_3D.GetAlgorithm(), 'NETGEN 1D-2D-3D')
smesh.SetName(NETGEN_3D_Simple_Parameters_1, 'NETGEN 3D Simple params')
