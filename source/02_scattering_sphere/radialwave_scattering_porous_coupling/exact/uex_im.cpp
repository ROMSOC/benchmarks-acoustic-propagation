...
class exp_uex_im : public dolfin::Expression
{ public:
    double r1, r2, r3;
    ...
    // Constructor
    exp_uex_im() : dolfin::Expression(3), 
    ...
    {  
        ...
        values[0] = u_mag.imag() * x[0] / r;
        values[1] = u_mag.imag() * x[1] / r;
        values[2] = u_mag.imag() * x[2] / r;
    }
};

PYBIND11_MODULE(SIGNATURE, m) {
    pybind11::class_<exp_uex_im, std::shared_ptr<exp_uex_im>, dolfin::Expression>
    (m, "exp_uex_im")
    .def(pybind11::init<>())
    .def_readwrite("coeffs", &exp_uex_im::coeffs)
    .def_readwrite("r1", &exp_uex_im::r1)
    .def_readwrite("r2", &exp_uex_im::r2)
    .def_readwrite("r3", &exp_uex_im::r3)
    .def_readwrite("k_f", &exp_uex_im::k_f)
    .def_readwrite("k_p", &exp_uex_im::k_p)
    .def_readwrite("rho_f", &exp_uex_im::rho_f)
    .def_readwrite("rho_p", &exp_uex_im::rho_p)
    .def_readwrite("omega2", &exp_uex_im::omega2)
    ;
}
