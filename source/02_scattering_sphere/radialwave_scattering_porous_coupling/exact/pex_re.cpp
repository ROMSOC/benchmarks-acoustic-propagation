...
class exp_pex_re : public dolfin::Expression 
{ public:
    double r1, r2, r3;
    double k_f;
    ...
    exp_pex_re() : dolfin::Expression(), r1(0.0), r2(0.0), r3(0.0), k_f(0.0), k_p(0.0) {}
...
PYBIND11_MODULE(SIGNATURE, m) {
    pybind11::class_<exp_pex_re, std::shared_ptr<exp_pex_re>, dolfin::Expression>
    (m, "exp_pex_re")
    .def(pybind11::init<>())
    .def_readwrite("coeffs", &exp_pex_re::coeffs)
    .def_readwrite("r1", &exp_pex_re::r1)
    .def_readwrite("r2", &exp_pex_re::r2)
    .def_readwrite("r3", &exp_pex_re::r3)
    .def_readwrite("k_f", &exp_pex_re::k_f)
    .def_readwrite("k_p", &exp_pex_re::k_p)
    ;
}
